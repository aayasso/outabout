...
-- delete is irreversible. Oldest row at the time of writing is 2026-04-15,
-- putting the first destructive run around October 2027 — far enough away to
-- be forgotten.
--
...
-- conditions are required, since the daily job also mentions aggregate_insights
-- but only calls compute_aggregate_insights(), which reads monetization_events
-- and deletes nothing.
